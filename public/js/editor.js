...
// Naming the button for submitting post differently to avoid conflicts
let submitButton = document.querySelector("#createPost");
...
async function createPostData() {
  ...
  let content = document.getElementById("text-input").innerHTML;
